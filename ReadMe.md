...
Add "github.com/Robbin-Liu/go-binance-sdk" dependency into your go.mod file. Example:
```go
require (
	github.com/Robbin-Liu/go-binance-sdk latest
)
...
```GO
import sdk "github.com/Robbin-Liu/go-binance-sdk/client"
...
For more API usage documentation, please check the [wiki](https://github.com/Robbin-Liu/go-binance-sdk/wiki)..
